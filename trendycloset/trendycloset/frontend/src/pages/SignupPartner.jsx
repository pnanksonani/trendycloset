    ...
    <div className="min-h-screen grid place-items-center bg-gradient-to-tr from-indigo-500 to-purple-600 p-6">
      <div className="w-full max-w-lg bg-white border border-zinc-200 rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="p-6 pb-0">
          <h1 className="text-3xl font-black">Sign up as Partner</h1>
          <p className="text-sm text-zinc-500 mt-1">
            Create a partner account to list products and manage incoming orders.
          </p>
        </div>
        ...
        <div className="p-6">
          <form onSubmit={onSubmit} noValidate className="grid gap-4">
            ...
            <div className="text-sm text-zinc-700">
              Want a user account instead?{' '}
              <Link to="/signup/user" className="text-indigo-600 hover:underline">
                Sign up as User
              </Link>
            </div>
          </form>
